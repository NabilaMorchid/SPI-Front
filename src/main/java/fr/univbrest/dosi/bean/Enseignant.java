...
public class Enseignant implements Serializable {
	...
	public Enseignant(String adresse, String codePostal, String nom, String ville) {
		super();
	...
	public Enseignant(long noEnseignant, String adresse, String codePostal, String emailUbo, String nom) {
		super();
	...
	public Enseignant(long noEnseignant, String codePostal, String nom, String type) {
		super();
		this.noEnseignant = noEnseignant;
		this.codePostal = codePostal;
		this.nom = nom;
